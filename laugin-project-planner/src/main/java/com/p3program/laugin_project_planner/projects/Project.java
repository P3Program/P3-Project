...
public class Project {
    ...
    public Project(long id, String title, String name, LocalDate date, boolean caldera, boolean warranty, String ssn, String phoneNum, String address, int postCode, String email, int hours, Date estDueDate, String priority, String description, String status) {
        this.id = id;
        this.title = title;
        this.name = name;
        this.date = date;
